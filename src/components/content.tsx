  ...
  return(
    <main className="grid grid-cols-2 px-28 pb-24">
      ...
      <div>
        ...
        <div className="flex flex-col gap-8 mt-[0.3rem]">
        ...
        <button className="mt-8 px-6 py-3 rounded-2xl text-neutral-white bg-neutral-black border-neutral-black border-2 hover:bg-transparent hover:text-neutral-black transition duration-300">Learn more</button>

        <div className="flex flex-row gap-12 mt-[6.5rem]">
          <DatabizLogo/>
          <AudiophileLogo/>
          <MeetLogo/>
          <MakerLogo/>
        ...
        <Image
        className="h-[75%] w-auto ml-36 mt-[-5rem]"
